 ...
 * 
 * Note that if we use `optional` together with another prop schema such as `custom`, the prop schema for `custom` will be applied first
 * and the result of that serialization will be used to feed into `optional`
 *
 * @example
